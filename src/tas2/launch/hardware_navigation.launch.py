...
def generate_launch_description():
    ...
    # pkg_scanMatcher = FindPackageShare(package="ros2_laser_scan_matcher").find("ros2_laser_scan_matcher")
    ...
    #map_yaml_file = os.path.join(pkg_share, "maps/new_map_lab.yaml")
    ...
    # Launching laser scan matcher instead of AMCL
    start_laser_scan_matcher_cmd = Node(
        ...
        parameters=[
            {
                ...
                "map_frame": "odom",
                "publish_tf": True,
                "laser_frame": "laser_front_link",
            },
        ],
        # remappings=[("/scan", "/scan_front")]       # doesn't work with merged scan. accuses invalid number of rays
    )
